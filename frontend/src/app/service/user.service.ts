...
export class UserService {  // Changed the service name to UserService
  ...
  updateUserFiles(payload: any): Observable<any> {
    return this.http.post(`${this.url}/user/updateUserFiles`, { payload });
  }
  ...
  getUserDashboard(): Observable<any> {
    return this.http.get(`${this.url}/user/dashboards`);
  }
 ...
 createOpportunity(payload: any): Observable<any> {
  ...
  createPaymentOpportunity(payload: any): Observable<any> {
